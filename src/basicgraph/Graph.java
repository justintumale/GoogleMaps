...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int i = 0; i < n; i++){
			...
			List<Integer> neighbors_ = new ArrayList <Integer>();
			neighbors_.addAll(getNeighbors(i));
			neighbors_.addAll(getInNeighbors(i));
			int degree = neighbors_.size();
	...
	public static void main (String[] args) {
		...
		GraphLoader.createIntersectionsFile("data/maps/Snellville.map", "data/intersections/Snellville.intersections");
